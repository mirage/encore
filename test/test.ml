...
let iso =
  ...
  [
    ...
    test_reject_fwd ~global:"int" ~name:"empty string"
      ~exn:Bijection.Exn.Bijection Exn.int "";
    test_reject_fwd ~global:"int" ~name:"invalid" ~exn:Bijection.Exn.Bijection
      Exn.int "invalid";
    ...
    test_reject_fwd ~global:"bool" ~name:"empty string"
      ~exn:Bijection.Exn.Bijection Exn.bool "";
    test_reject_fwd ~global:"bool" ~name:"invalid" ~exn:Bijection.Exn.Bijection
      Exn.bool "invalid";
    ...
    test_reject_fwd ~global:"product" ~name:"empty string"
      ~exn:Bijection.Exn.Bijection (product Exn.int Exn.bool) ("invalid", "true");
    test_reject_fwd ~global:"product" ~name:"empty string"
      ~exn:Bijection.Exn.Bijection (product Exn.int Exn.bool) ("true", "invalid");
    test_fwd ~global:"subset" Alcotest.char (Exn.subset (( = ) 'a')) 'a' 'a';
    test_bwd ~global:"subset" Alcotest.char (Exn.subset (( = ) 'a')) 'a' 'a';
    test_reject_fwd ~global:"subset" ~name:"a" ~exn:Bijection.Exn.Bijection
      (Exn.subset (( = ) 'a'))
      'b';
    test_reject_bwd ~global:"subset" ~name:"a" ~exn:Bijection.Exn.Bijection
      (Exn.subset (( = ) 'a'))
      'b';
  ]
...
let parser =
  let make_test :
   ...
   fun name (module Combinator) value sentinel s ->
    ...
    Alcotest.(check value) "decode" (of_string s) sentinel in
  let make_reject :
      type sentinel.
      string ->
      (module COMBINATOR with type sentinel = sentinel) ->
    ...
    [
      ...
      (let combinator =
         (module struct
           ...
           with type sentinel = char * char) in
       [
    ...
    [
      ...
      (let combinator =
         (module struct
           ...
           with type sentinel = char option) in
       let fail =
         (module struct
           ...
           with type sentinel = unit option) in
       List.concat
         [
